...
const ListRender = () => {
    ...
    const deleteRandom = () => {
        ...
        setUsers((prevUsers) =>{
            ...
            //Usamos Filter para criar um novo array, Excluindo apenas o ID que for igual ao  número sorteado(randomNumber), mantendo os diferentes;
        })
  ...
  return (
    <div>
        ...
        <ul style={{listStyleType: "none"}}>
            ...
            {users.map((user) =>(
                <li key={user.id}>
                    <strong>ID: {user.id} - {user.name} - {user.age} anos</strong>
                </li>
            ))}
        </ul>
