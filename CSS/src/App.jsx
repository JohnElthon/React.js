...
function App() {
  ...
  return (
    <>
      ...
      >
        Formatação com CSS Inline
      </p>

      {/* CSS Inline Dinâmico */}
      <p style={{ color: autor === "John" ? "Black" : "blue" }}>
        Formatação com CSS Inline Dinâmico
      </p>

      <p
        style={{
          color: autor === "John" ? "Black" : "blue",
          backgroundColor: autor === "John" ? "lightblue" : "red",
        }}
      >
        Formatação com CSS Inline Dinâmico 2
      </p>

       {/* Classes Dinâmicas */}
       <h1 className={autor === 'John' ? 'john' : 'titulo'}>Formatação com Classe Dinâmica</h1>
    </>
  );
}
